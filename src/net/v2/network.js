...
export async function init (conf) {
  ...
  let config = {
    ...
    checkName: 'Game.Demo.Sample.CheckAction',
    fields: [
      {
        name: 'data',  // 需要解碼的欄位名稱
        rootName: 'Game.Demo.Sample',  // package name
      ...
      {
        name: 'info',  // 需要解碼的欄位名稱
        rootName: 'Game.Demo.Sample.Info',  // package name
        typeName: 'ActionType',   // 命令清單代碼
        cmdList: [  // 命令清單
          'BaseResponse'
        ]
      },
      {
        ...
        rootName: 'Game.Demo.Sample.Jackpot',  // package name
        typeName: 'ActionType',   // 命令清單代碼
        cmdList: [  // 命令清單
          'BaseResponse'
        ]
      },
      {
        ...
        rootName: 'Game.Demo.Sample.Setting',  // package name
        typeName: 'ActionType',   // 命令清單代碼
        cmdList: [  // 命令清單
          'BaseResponse'
        ]
